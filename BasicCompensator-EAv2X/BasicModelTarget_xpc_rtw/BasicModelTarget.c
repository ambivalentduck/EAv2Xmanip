...
void BasicModelTarget_output(int_T tid)
{
  ...
  if (rtmIsMajorTimeStep(BasicModelTarget_rtM) &&
    ...
    /* Product: '<S2>/Divide' */
    BasicModelTarget_B.Divide[0] = BasicModelTarget_B.RadialVec[0] /
      BasicModelTarget_B.Fcn4;
    BasicModelTarget_B.Divide[1] = BasicModelTarget_B.RadialVec[1] /
      BasicModelTarget_B.Fcn4;
  }
  ...
  if (tid == 0) {
    ...
    BasicModelTarget_B.DotProduct_a = BasicModelTarget_B.Derivative1 *
      BasicModelTarget_B.Divide[0] + BasicModelTarget_B.Derivative3 *
  ...
  if (tid == 0) {
    /* Product: '<S1>/Product1' */
    BasicModelTarget_B.Product1_h = BasicModelTarget_B.Gain *
      BasicModelTarget_B.Derivative1;

    /* Product: '<S1>/Product4' */
    BasicModelTarget_B.Product4_m = BasicModelTarget_B.Unpack_o3 *
      BasicModelTarget_B.Derivative3;

    /* Product: '<S1>/Product6' */
    BasicModelTarget_B.Product6_c = BasicModelTarget_B.Unpack_o3 *
      BasicModelTarget_B.Derivative1;

    /* Sum: '<S1>/Sum1' */
    BasicModelTarget_B.Sum1_a = BasicModelTarget_B.Product6_c -
      BasicModelTarget_B.Product4_m;

    /* Sum: '<S1>/Sum of Forces - Y' */
    BasicModelTarget_B.SumofForcesY = BasicModelTarget_B.Product1_h +
      BasicModelTarget_B.Sum1_a;

    /* Product: '<S2>/Product8' */
    BasicModelTarget_B.Product8 = BasicModelTarget_B.SumofForcesY *
  ...
  if (tid == 0) {
    ...
    /* Sum: '<Root>/Sum2' */
    BasicModelTarget_B.Sum2 = BasicModelTarget_B.Product +
  ...
  if (tid == 2) {
     ...
     *  Constant: '<S6>/Input Param3'
     */
    BasicModelTarget_B.Sum2_f = BasicModelTarget_B.PCI6031EAD_o2 -
...
void BasicModelTarget_initialize(boolean_T firstTime)
{
  ...
  /* external mode info */
  BasicModelTarget_rtM->Sizes.checksums[0] = (2913798464U);
  BasicModelTarget_rtM->Sizes.checksums[1] = (2872830736U);
  BasicModelTarget_rtM->Sizes.checksums[2] = (2689146284U);
  BasicModelTarget_rtM->Sizes.checksums[3] = (2059745162U);
...

  {
    ...
    BasicModelTarget_B.Product1_h = 0.0;
    BasicModelTarget_B.Product4_m = 0.0;
    BasicModelTarget_B.Product6_c = 0.0;
    BasicModelTarget_B.Sum1_a = 0.0;
...
void MdlInitializeSizes(void)
{
  ...
  BasicModelTarget_rtM->Sizes.numBlocks = (201);/* Number of blocks */
  BasicModelTarget_rtM->Sizes.numBlockIO = (197);/* Number of block outputs */
  BasicModelTarget_rtM->Sizes.numBlockPrms = (521);/* Sum of parameter "widths" */
}
