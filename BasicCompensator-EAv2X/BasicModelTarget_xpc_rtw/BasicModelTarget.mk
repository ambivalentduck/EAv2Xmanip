...
#
# File    : xpc_vc.tmf   $Revision: 1.1.6.24 $ $Date: 2009/08/29 08:30:23 $
#
# Abstract:
...
MODEL           = BasicModelTarget
MODULES         = BasicModelTarget_capi.c BasicModelTarget_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_mod_snf.c rt_nonfinite.c rt_pow_snf.c rt_printf.c rt_zcfcn.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = BasicModelTarget.mk
...
S_FUNCTIONS     = danipcie.c xpcudpbytesend.c xpcudpbytereceive.c dipci8255.c dopci8255.c adnipcie.c xpcionie.c
S_FUNCTIONS_LIB = 
NUMST           = 5
TID01EQ         = 1
NCSTATES        = 14
...
MULTITASKING    = 1
EXT_MODE        = 0
MEX_OPT_FILE    = -f C:\Users\Justin\AppData\Roaming\MATHWO~1\MATLAB\R2010a\mexopts.bat
...
MODELLIB                  = BasicModelTargetlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\Justin\Desktop\ProjectFiles\BasicCompensator-EAv2X\BasicModelTarget_xpc_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\Justin\Desktop\ProjectFiles\BasicCompensator-EAv2X
