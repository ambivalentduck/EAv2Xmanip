...
typedef struct {
  ...
  real_T Gain;                         /* '<S1>/Gain' */
  real_T Product1_h;                   /* '<S1>/Product1' */
  real_T Product4_m;                   /* '<S1>/Product4' */
  real_T Product6_c;                   /* '<S1>/Product6' */
  ...
  uint8_T RateTransition3[24];         /* '<S1>/Rate Transition3' */
  uint8_T Pack1[72];                   /* '<Root>/Pack1' */
  uint8_T RateTransition_i[72];        /* '<Root>/Rate Transition' */
  uint8_T Receive_o1[24];              /* '<S1>/Receive' */
...
typedef struct {
  ...
  uint8_T RateTransition3_Buffer0[24]; /* '<S1>/Rate Transition3' */
...
struct Parameters_BasicModelTarget_ {
  ...
  real_T ywm_Value;                    /* Expression: .66
                                        ...
                                        */
  real_T ywp_Value;                    /* Expression: .40
                                        * Referenced by: '<S2>/ywp'
                                        */
  real_T Gain2_Gain;                   /* Expression: .5
                                        * Referenced by: '<S2>/Gain2'
                                        */
  real_T r_Value;                      /* Expression: .15
                                        * Referenced by: '<S2>/r'
                                        */
  ...
  real_T PCIDIO961_P10;                /* Expression: boardType
                                        * Referenced by: '<S14>/PCI-DIO-96 1'
                                        */
  real_T InputParam3_Value_m;          /* Expression: 0.145
                                        * Referenced by: '<S6>/Input Param3'
                                        */
